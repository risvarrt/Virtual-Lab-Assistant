...
class FormAward extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  form = (event) => {
    const data = {
      ...
      issueDate: this.state.courseStart,
        ...
        <div className="form-side">
          ...
          <ModalBody>
            <Form onSubmit={(e) => this.form(e)}>
              ...
              <Row className="form-group">
                <Label htmlFor="issuer" sm={12} className="mt-2">
                ...
                <Colxx sm={12}>
                  <Input
                    ...
                    model=".issuer"
                    type="text"
                    innerRef={(input) => (this.issuer = input)}
                    required
                  />
                </Colxx>
              </Row>
