...
export default class BlankPage extends Component {
    ...
    componentDidMount = async () => {
        try{var player = await Axios.post("http://localhost:5000/users/studentclassList",{ 
    ...
    onSt = (x,e) =>{
        ...
        const players = this.state.players[x].staff_id;
        const playerStats2 =[class_name, class_code,players];
        this.props.history.push('/app/student_class_details',playerStats2);
        }
