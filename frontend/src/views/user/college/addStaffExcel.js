...
class AddStaff extends Component {
  ...
  onStaffRegister = async(e) => {
    ...
    data.append("file", this.state.file);
        try {
          var loginRes = await Axios.post("http://localhost:5000/users/xlstojsonStaff", data);
          ...
          <Card className="auth-card">
            ...
            <div className="form-side">
              ...
              <CardTitle className="mb-4">
                  <IntlMessages id="Add Staff via Excel Sheet" />
                </CardTitle>

                <CardTitle className="mb-4">
                  <p className="para">
                  <b>Constraints:</b><br/>
                  1. Your Excel sheet should only have 4 columns<br/>
                  2. Names of the columns should be:<br/>
                  a) staff_id<br/>
                  b) name<br/>
                  c) email<br/>
                  d) phone_number<br/><br/>
