...
class CollegeRegister extends Component {
  ...
  onUserRegister = async(e) => {
    ...
    try {
      ...
      //console.log(newUser)
      const regRes = await Axios.post("http://localhost:5000/users/registerStaff", newUser);
      console.log(regRes.data.college_id);
      this.props.history.push("/user/colleges/staffLogin");
    } catch (err) {
      ...
      <Row className="h-100">
        <Colxx xxs="12" md="10" className="mx-auto my-auto">
          ...
          <CardTitle className="mb-4">
                <IntlMessages id="Staff - Register" />
              </CardTitle>{" "}
